...
impl Acknowledge {
    ...
    pub fn create(packet_type: PacketType, record_count: u16, single_sequence_number: bool, sequence_number: Option<u32>, start_sequence_number: Option<u32>, end_sequence_number: Option<u32>) -> Acknowledge {

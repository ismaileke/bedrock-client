...
impl CraftRecipeOptionalStackRequestAction {
    pub fn new(recipe_id: i32, filter_string_index: i32) -> CraftRecipeOptionalStackRequestAction {
        CraftRecipeOptionalStackRequestAction { recipe_id, filter_string_index }
    }

    pub fn read(stream: &mut Reader) -> CraftRecipeOptionalStackRequestAction {

...
impl ItemStackRequestNetworkItemInstanceDescriptor {
    pub fn new(ingredient: RecipeIngredient, block_runtime_id: u32, raw_extra_data: String) -> ItemStackRequestNetworkItemInstanceDescriptor {
    ...
    pub fn write(&self, stream: &mut Writer) {
        ...
        PacketSerializer::put_string(stream, &self.raw_extra_data);
    }
}

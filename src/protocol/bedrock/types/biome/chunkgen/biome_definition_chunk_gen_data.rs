...
pub struct BiomeDefinitionChunkGenData {
    ...
    pub sub_surface_builder_data: Option<BiomeSurfaceBuilderData>,
}
...
impl BiomeDefinitionChunkGenData {
    pub fn new(
        ...
        surface_builder_data: Option<BiomeSurfaceBuilderData>,
        sub_surface_builder_data: Option<BiomeSurfaceBuilderData>,
    ) -> Self {
